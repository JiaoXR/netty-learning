package com.jaxer.dubbo.provider.handler;
 ...
 * @author jaxer
 */
public class DubboProviderHandler extends SimpleChannelInboundHandler<InvokeMessage> {
    // 注册中心
    private Map<String, Object> registry;

    public DubboProviderHandler(Map<String, Object> registry) {
